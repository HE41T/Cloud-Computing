...
**Private Cloud** เป็นรูปแบบ Cloud ที่ ใช้งานเฉพาะองค์กรเดียวเท่านั้น (Single-Tenant)
โดยโครงสร้างพื้นฐานอาจ ติดตั้งอยู่ใน Data Center ขององค์กรเอง
หรือเป็น Dedicated Cloud ที่ผู้ให้บริการจัดเตรียมให้แบบเฉพาะราย
ทรัพยากรทั้งหมด เช่น เซิร์ฟเวอร์ ระบบเครือข่าย และระบบจัดเก็บข้อมูล
จะไม่ถูกแชร์กับลูกค้ารายอื่น ทำให้องค์กรสามารถควบคุมความปลอดภัย
นโยบาย และการกำหนดค่าระบบได้อย่างเต็มที่
