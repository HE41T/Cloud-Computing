...
- Cloud Computing คือการที่เรา
จัดการ การใช้งาน และเข้าถึงทรัพยากรด้าน IT จากระยะไกล
ไม่ว่าจะเป็น ฮาร์ดแวร์ (เช่น เซิร์ฟเวอร์, Storage, Network)
หรือ ซอฟต์แวร์ (เช่น ระบบงาน แอปพลิเคชัน ฐานข้อมูล)
โดยทั้งหมดอยู่บนระบบของผู้ให้บริการ และเราเข้าถึงผ่านเครือข่าย

แทนที่จะต้องมีเครื่องแรง ๆ หรือเซิร์ฟเวอร์ในบริษัท
Cloud จะทำหน้าที่เป็น “ศูนย์กลาง” ให้เราใช้งานทุกอย่างผ่านอินเทอร์เน็ต
